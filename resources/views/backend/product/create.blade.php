      ...
      <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="1 &amp; 2: 40.5 x 16.5 x 18 mm">1 &amp; 2: 40.5 x 16.5 x 18 mm</option>
              <option value="3: 39.79 x 18.26 x 19.21 mm">3: 39.79 x 18.26 x 19.21 mm</option>
              <option value="Pro 2: 30.9 x 21.8 x 24 mm">Pro 2: 30.9 x 21.8 x 24 mm</option>
        ...
        <div class="form-group">
          ...
          <div id="color-code-list">
            @php $colorCodes = old('color_code', ['']); @endphp
            @foreach((array) $colorCodes as $colorCode)
        ...
        <div class="form-group">
          ...
          <div class="input-group">
              ...
              <span class="input-group-btn ml-2">
                  <a id="lfm" data-input="thumbnail" data-preview="holder" data-prefix="{{ url('laravel-filemanager') }}" class="btn btn-primary">
