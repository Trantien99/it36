...
@section('title','Web bán tai nghe || Chi tiết bài viết')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Chi Tiết Bài Viết</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Bình luận</span><span class="comment_btn reply" style="display: none;">Trả lời bình luận</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
