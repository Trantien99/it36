...
@section('title','Web bán tai nghe || Danh sách yêu thích')
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
                                        ...
                                        <td>
                                            <form action="{{route('add-to-cart',$wishlist->product['slug'])}}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn text-white">Th&#234;m v&#224;o gi&#7887; h&#224;ng</button>
                                            </form>
                                        </td>
                                        <td class="action" data-title="Remove">
                                            <form action="{{route('wishlist-delete',$wishlist->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="action-button-reset"><i class="ti-trash remove-icon"></i></button>
                                            </form>
                                        </td>
									</tr>
								@endforeach
