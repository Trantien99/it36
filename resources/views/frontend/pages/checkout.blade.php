...
@section('title','Web bán tai nghe || Thanh toán')
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method" type="radio" value="cod" {{ old('payment_method', 'cod') == 'cod' ? 'checked' : '' }} required> <label> Thanh Toán Khi Giao Hàng</label><br>
{{--                                                <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label>--}}
                                                <input name="payment_method" type="radio" value="momo" {{ old('payment_method') == 'momo' ? 'checked' : '' }}> <label> MoMo Test</label><br>
                                                <small class="text-muted d-block mt-2">Bạn sẽ được chuyển sang cổng MoMo sandbox để thanh toán thử.</small>
                                            </form-group>
