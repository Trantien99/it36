                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <form action="{{route('single-add-to-cart')}}" method="POST" class="mt-4">
                                            ...
                                            @if($product->color_code)
                                                ...
                                                <label for="home-product-color-code-{{$product->id}}">Chọn mã màu</label>
                                                <select id="home-product-color-code-{{$product->id}}" name="color_code" class="form-control mb-3" required>
